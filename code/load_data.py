...
def load_MI(subject, training, PATH):
	...
	data_return = a['data_return']
	class_return = a['class_return']
	data_return = data_return[:,0:22,:]
...
def load_session_2b(content, classlabel):
	...
	# load signal struct since h.EVENT is not a dict anymore
	event_type = content['h']['EVENT'][0, 0]
