clear all
path_open = 'G:\NoGitWork\DATA\MIdataset\BCICIV_2a_gdf\';
path_save = 'G:\Git_Repository\MATLAB\EEG_Riemannian\data\BCICIV_2a\train\';
subject = strcat(path_open,'A09T.gdf');
...
%% save
subject = 9;
name = strcat('A0',int2str(subject),'T.mat');
